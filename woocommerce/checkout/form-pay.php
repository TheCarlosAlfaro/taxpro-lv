	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'taxPro' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'taxPro' ); ?></th>
			</tr>
		</thead>
		<tbody>
