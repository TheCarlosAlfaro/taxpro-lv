    ...
    <div class="row">
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" src="http://tax-pro-lv.local/wp-content/uploads/2018/12/team-m-1.jpg" alt="Card image cap">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" src="http://tax-pro-lv.local/wp-content/uploads/2018/12/team-m-3.jpg" alt="Card image cap">
                <div class="card-body text-center">
            ...
            <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                <img class="card-img-top" src="http://tax-pro-lv.local/wp-content/uploads/2018/12/team-m-2.jpg" alt="Card image cap">
                <div class="card-body text-center">
