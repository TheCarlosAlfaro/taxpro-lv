...
<section id="hero-section">
  ...
  <div class="jumbotron jumbotron-fluid">
    ...
    <div class="hero-content">
      ...
      <div>
        <img src="http://tax-pro-lv.local/wp-content/uploads/2018/12/Logo-TaxPro-Final-Corregido-Ingles.png" alt="" class="heading-logo mb-5">
      </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="social">
        <a href="https://www.facebook.com/taxprolv/" target="_blank">
        <i class="fa fa-facebook"></i>
      </a>
      <a href="https://www.instagram.com/taxprolv/" target="_blank">
